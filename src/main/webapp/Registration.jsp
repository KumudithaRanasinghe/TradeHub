                        ...
                        <div class="form-box">
                            <form class="form">
                                ...
                                <div id="individualFields" style="display: block; ">
                                    ...
                                    <div class="inputForm mb-3">
                                        <input type="text" placeholder="Enter your Phone Number" class="input" required>
                                    </div>
                                    <div class="flex-column">
                                        <label>Address</label></div>
                                    <div class="inputForm mb-3">
                                        <input type="text" placeholder="Enter your Address" class="input" required>
                                    </div>
                                </div>
                                <div id="businessFields" style="display: change; ">
                                    ...
                                    <div class="inputForm mb-3">
                                        <input type="text" placeholder="Enter your Business Name" class="input" required>
                                    </div>
                                    <div class="flex-column">
                                        <label>Business Type</label>
                                    </div>
                                    <div class="inputForm mb-3">
                                        <input type="text" placeholder="Enter Your Business Type" class="input" required>
                                    </div>
                                    <div class="flex-column">
                                        <label>Business Address</label>
                                    </div>
                                    <div class="inputForm mb-3">
                                        <input type="text" placeholder="Enter your Business Address" class="input" required>
                                    </div>
                                    <div class="flex-column">
                                        <label>Business Phone Number</label>
                                    </div>
                                    <div class="inputForm mb-3">
                                        <input type="text" placeholder="Enter your Business Phone Number" class="input" required>
                                    </div>
                                    <div class="flex-column">
                                        <label>Business Email</label>
                                    </div>
                                    <div class="inputForm mb-3">
                                        <input type="text" placeholder="Enter your Business Email" class="input" required>
                                    </div>
                                </div>
                                <div class="flex-row">
                                    <input type="checkbox">
