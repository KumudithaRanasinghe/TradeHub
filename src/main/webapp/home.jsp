...
<html>
    ...
    <div class="side-menu">
        <ul>
            ...
            <p><a href="">Electronics<i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
            <p><a href="">Home & Lifestyle<i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
            <p><a href="">Medicine<i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
            <p><a href="">Sports & Outdoor<i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
            <p><a href="">Baby's & Toys<i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
            <p><a href="">Groceries & Pet's<i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
            <p><a href="">Health & Beauty<i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
        </ul>
    </div> 
    </section>
  ...
  <h4>Today's<button class="tittle-box-button">View All</button></h4>
  <h1>Flash sales</h1>
  </div>
...
<!--    </div>-->
    ...
    <div class="container">
    <div class="tittle-box">
      <h4>This Months<button class="tittle-box-button">View All</button></h4>
      <h1>Best Selling products</h1>
      </div>
      </div>
      <div class="container">
        <button class="catagerory-button">Electronics</button>
        <button class="catagerory-button">Home & lifestyle</button>
        <button class="catagerory-button">Medicine</button>
        <button class="catagerory-button">sports & Outdoor</button>
        <button class="catagerory-button">Baby's and Toy</button>
        <button class="catagerory-button">Groceries & Pets</button>
        <button class="catagerory-button">Health & Beauty</button>
      </div>
